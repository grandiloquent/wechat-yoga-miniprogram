...
${this.data .map((element,index)=>{
  return html`<div class="item" data-index="${index}" @click="${this.navigate}">${element.getDate()}</div>`;
  })}
  </div>
