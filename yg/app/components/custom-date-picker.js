...
export class CustomDatePicker extends LitElement {
  ...
  _next() {
    ...
    this.data = this._getDays(d.getMonth() + 1, d.getFullYear());
    this._date = `${d.getFullYear()}年${d.getMonth()+1}月`;
    this._pad = [...new Array(this.data[0].getDay()).keys()];
  ...
  <div class="dialog-body">
    <div class="nav pre" @click=${this._pre}>
      <svg viewBox="0 0 24 24">
        <path d="M15.422 16.594l-1.406 1.406-6-6 6-6 1.406 1.406-4.594 4.594z"></path>
      </svg>
    </div>
    <div class="title">${this._date}</div>
    <div class="nav next" @click=${this._next}>
      <svg viewBox="0 0 24 24">
