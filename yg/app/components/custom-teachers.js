...
export class CustomTeachers extends LitElement {
  static properties = {
    data: {}
  };
...
.bottom {
  ...
  navigate(evt) {
    ...
    window.location = `./teacher?id=${index}`
  }
  render() {
...
customElements.define('custom-teachers', CustomTeachers);
/*
<!--
<script type="module" src="../components/custom-teachers.js"></script>
<custom-teachers bind @submit=""></custom-teachers>
                                         -->
                                     */
